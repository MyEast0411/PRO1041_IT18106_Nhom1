...
import com.swing.ButtonOutLine;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                title.setText("Nhóm 1");
                description.setText("Phần mềm bán bia đóng sẵn");
                description1.setText("...");
                button.setText("Quên mật khẩu");
            } else {
                title.setText("Nhóm 1");
                description.setText("Đã có tài khoản");
                description1.setText("Vui lòng đăng nhập");
